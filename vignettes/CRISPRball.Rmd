...
In this example, the two datasets are just reverse comparisons (ESC vs plasmid & plasmid vs ESC) where DDX27 has been altered in the ESC vs plasmid comparison to no longer be a significant hit.
