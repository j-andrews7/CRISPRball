...
#' @param dim.x The principal component to plot on the x-axis (default "PC1")
#' @param dim.y The principal component to plot on the y-axis (default "PC2")
#' @param dim.z The principal component to plot on the z-axis (default NULL)
#' @param plot.title The title of the plot (default "PCA Biplot")
#' @param color.by Column name to use for coloring points (default NULL)
#' @param shape.by Column name to use for shaping points (default NULL)
#' @param hover.info Column name(s) to include in the hover info for each point (default NULL)
#' @param show.loadings Whether to show component loadings on the plot (default FALSE)
#' @param n.loadings The number of loadings to show (default 3)
#' @param pt.size The size of the plotted points (default 12)
