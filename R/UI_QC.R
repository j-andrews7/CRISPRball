    ...
    tabPanel(
        ...
        sidebarLayout(
            ...
            mainPanel(
                ...
                fluidRow(
                    column(width = 4,
                            span(popify(icon("circle-info", style="font-size: 20px"), "Gini Index",
                            ...
                            span(popify(icon("circle-info", style="font-size: 20px"), "Read Distributions",
                    ...
                    column(width = 4,
                            span(popify(icon("circle-info", style="font-size: 20px"), "Zero Count gRNAs",
                            ...
                            span(popify(icon("circle-info", style="font-size: 20px"), "Sample Correlations",
                    ...
                    column(width = 4,
                            span(popify(icon("circle-info", style="font-size: 20px"), "Mapping Rates",
                                        c("This plot shows read mapping rates for each sample. 50-75% mapped is typical."),
                                        placement = "bottom", trigger = "hover", options = list(container = "body")),
                                jqui_resizable(plotOutput("qc.map"))),
                            span(popify(icon("circle-info", style="font-size: 20px"), "Principal Componenet Analysis",
